...
- Expand time-management coverage with unit tests for each control (bullet, blitz, rapid, classical, infinite) and emergency-mode behavior. (Initial coverage added; extend to control-specific scenarios.)
